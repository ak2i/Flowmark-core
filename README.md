...
```bash
node bin/flowmark.js validate docs/dev/v0.1.3/samples/minimal.md
node bin/flowmark.js validate docs/dev/v0.1.3/samples/spec-conformant.md
node bin/flowmark.js validate docs/dev/v0.1.3/samples/ai-template.md
```
...
```bash
npm pack
tar -tf flowmark-core-cli-0.1.3.tgz
```
